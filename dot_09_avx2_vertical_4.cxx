// dot_09_avx2_vertical_4.cxx


// Compile:
//    g++-10 -Wall -Wpedantic -std=c++17 -mavx2 -O3 dot_09_avx2_vertical_4.cxx -o avx2_vertical_4.exe

// Usage:
//    ./avx2_vertical_4.exe len
...
double dot_09_avx2_vertical_4(std::int32_t n, double x[], double y[])
{
  ...
  for (std::int32_t i = 0; i < n; i += 16) {
    ...
    temp3 = _mm256_add_pd(_mm256_mul_pd(vx, vy), temp3);
...
int main(int argc, char** argv)
{
  ...
  double dot = dot_09_avx2_vertical_4( len, x.data(), y.data() );

  auto t1  = std::chrono::steady_clock::now();
       dot = dot_09_avx2_vertical_4( len, x.data(), y.data() );
