...
// Compile:
//    g++-10 -Wall -Wpedantic -std=c++17 -mavx512f -O3 dot_13_avx512_vertical.cxx -o avx512_vertical.exe

// Usage:
//    ./avx512_vertical.exe len
...
int main(int argc, char** argv)
{
  ...
  auto t1  = std::chrono::steady_clock::now();
       dot = dot_13_avx512_vertical( len, x.data(), y.data() );
