...
// Compile:
//    g++-10 -Wall -Wpedantic -std=c++17 -mavx2 -mfma -O3 dot_12_avx2_vertical_fma_4.cxx -o avx2_vertical_fma_4.exe
...
double dot_12_avx2_vertical_fma_4(std::int32_t n, double x[], double y[])
{
...
int main(int argc, char** argv)
{
  ...
  double dot = dot_12_avx2_vertical_fma_4( len, x.data(), y.data() );

  auto t1  = std::chrono::steady_clock::now();
       dot = dot_12_avx2_vertical_fma_4( len, x.data(), y.data() );
